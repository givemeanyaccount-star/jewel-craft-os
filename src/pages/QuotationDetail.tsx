        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 ml-auto max-w-sm space-y-1.5 text-sm">
              ...
              {Number(q.luxury_tax) > 0 && <Row label={`Luxury tax ${q.luxury_tax_rate}% (gold + making − old metal)`} value={npr(q.luxury_tax)} />}
              {Number(q.old_gold_credit) > 0 && <Row label="Old metal credit" value={`- ${npr(q.old_gold_credit)}`} />}
            ...
            <div className="mt-6 text-[10px] text-muted-foreground print:mt-8">
              This quotation is an estimate based on today's metal rates. Final invoice values may vary with rate movement. Gold and making charges are exempt from VAT; where applicable VAT applies to stones only. SD tax (0.5%) applies to gold + making − old metal value per Nepal tax rules.
            </div>
          </CardContent>
        </Card>
      </div>
